...
function generateCocktail(event) {
  ...
  let context =
    "Please give clear instructions and provide measurements both in oz and ml. List ALL the necessary ingredients. Format your answer in HTML with cocktail name in <h4>, ingredients in <ul> with list-style-type: none, under title 'ingredients', and method in <ul> with list-style-type: decimal under title 'method'. Add the type of glassware to serve at the end, under title 'glassware'. Please add <br> when necessary. Don't include any images.";
